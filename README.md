...
NewBee 有两层意思：一是 NewBee，新手。二是发音牛逼，高手的意思。整体设计原则是：（1）没有很高的门槛、容易使用；（2）上限高，可以做很 NB 的事情。
...
- [NewBeeFin](https://github.com/nscript-site/NewBeeFin)：AI辅助金融投资研究工具，基于 BS 开发。